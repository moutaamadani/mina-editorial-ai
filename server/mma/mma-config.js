...
export function getMmaConfig() {
  ...
  const seadreamModel = pickEnv(["MMA_SEADREAM_MODEL_VERSION", "SEADREAM_MODEL_VERSION"], "bytedance/seedream-4");
  ...
  const klingModel = pickEnv(["MMA_KLING_MODEL_VERSION", "KLING_MODEL_VERSION"], "kwaivgi/kling-v2.1");
